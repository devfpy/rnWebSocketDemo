...
class CustomVew extends Component {
    ...
    render() {
        return (<img src={require('./src/images/avater_default.png')}></img>)
    }
}
...
export default class App extends Component {
    ...
    componentDidMount() {
        ...
        //订阅接收消息事件
        this.newMessageSubscription = DeviceEventEmitter.addListener('receivedMsg', (obj) => {
    ...
    onSendGalleryFiles = (mediaFiles) => {
        ...
        for (index in mediaFiles) {
            ...
            Ws.sendMessage('file', message);

            // RNFS.readFile(mediaFiles[index].mediaPath);
        }
